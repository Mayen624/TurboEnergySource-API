...
route.post('/new_service', isAuthenticated, csrfProtection, CheckUserPermission(['create:service']), upload.array('images', 2), servicesController.addService);

route.put('/:id', isAuthenticated, csrfProtection, CheckUserPermission(['edit:service']), upload.array('images', 2), servicesController.updateService);
